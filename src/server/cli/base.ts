 ...
 */
export function capturePane(sessionName: string, lines = 500): { output: string; error?: string } {
  try {
    const out = execSync(
 ...
 * @returns 操作结果
 */
export function sendInput(sessionName: string, text: string): { ok: boolean; error?: string } {
