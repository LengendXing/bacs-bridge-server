...
# 🇸🇦 نظام جسر Bot × AI-CLI (bacs-bridge-server)

> حوّل روبوت الدردشة إلى واجهة تفاعل عن بُعد مع أدوات AI CLI مثل Claude Code / Codex. لا حاجة بعد الآن للدخول عبر SSH إلى الخادم وفتح طرفية — فقط أشر إلى الروبوت بـ @ في مجموعة الدردشة، واستطع تشغيل واحد أو أكثر من عمليات البرمجة بالذكاء الاصطناعي.
...
**bacs-bridge-server** هو نظام جسر ثنائي الاتجاه بين روبوتات الدردشة وأدوات AI CLI (Claude Code / Codex). يعمل خادم Bridge دائم التشغيل على توجيه أحداث رسائل الدردشة إلى عمليات CLI محددة، ثم يعيد إرسال ردود CLI إلى مجموعة الدردشة أو المحادثة الخاصة المقابلة.

سيناريوهات الاستخدام:
- التعاون عبر مجموعات الدردشة لتشغيل مهام البرمجة بالذكاء الاصطناعي ضمن الفريق
- التحكم عن بُعد في Claude Code على الخادم في حالات عدم توفر جهاز كمبيوتر (هاتف، جهاز لوحي)
- ربط عمليات AI متعددة على نفس الخادم بمجموعات دردشة مختلفة لعزل المشاريع
...
| الوحدة | القدرة |
|--------|--------|
| **ربط آلات متعددة** | دعم إدارة عمليات CLI متعددة على نفس الخادم في وقت واحد (cc-a / cc-b / codex-x ...)، كل عملية مرتبطة بروبوت دردشة مستقل |
...
│   │   ├── channel/          # قناة الدردشة WS + واجهة مجردة
│   │   ├── cli/              # محول CC / Codex
...
**س: لا استجابة بعد إرسال رسالة في الدردشة؟**
